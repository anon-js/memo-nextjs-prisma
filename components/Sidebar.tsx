...
export function Sidebar({ user, memos }: SidebarProps) {
  ...
  const [optimisticMemos, setOptimisticMemos] = useState<Memo[]>(memos);
  ...
  return (
    <aside className="w-64 bg-gray-50 border-r border-gray-200 hidden md:flex flex-col h-screen relative z-20">
      <div className="flex-1 flex flex-col min-h-0">
        <div className="p-2 flex items-center justify-center">
          <button 
            ...
            className="flex flex-row items-center gap-2 flex-1 hover:bg-gray-200 p-2 rounded transition text-gray-500 hover:text-gray-900"
          >
            <Plus size={16} />
      ...
      <div className="border-t border-gray-200 p-2 relative bg-gray-50">
        <Dropdown 
          trigger={
            <div className="w-full flex items-center gap-2 p-1.5 rounded-md hover:bg-gray-200 transition text-left group cursor-pointer">
